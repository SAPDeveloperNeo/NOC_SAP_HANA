...
Namespace SAP_HANA
    Public Class C_LedgerBasicSetup : Implements ISAP_HANA
        ...
        Public Sub Form_Process_ItemEvents(FormUID As String, ByRef pVal As ItemEvent, ByRef BubbleEvent As Boolean) Implements ISAP_HANA.Form_Process_ItemEvents
            Try
                ...
                If pVal.Before_Action = False Then
                    If pVal.FormTypeEx = "SAP_UDO_OLBS" And pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_RESIZE Then
                ...
                ElseIf pVal.Before_Action = True Then
                    If pVal.FormTypeEx = "SAP_UDO_OLBS" And pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_LOAD Then
