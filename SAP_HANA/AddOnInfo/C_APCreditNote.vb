...
Namespace SAP_HANA
    ...
    Public Class C_APCreditNote : Implements ISAP_HANA
...
#End Region
            ...
            Try
                ...
                If oForm.Mode = BoFormMode.fm_ADD_MODE Or oForm.Mode = BoFormMode.fm_OK_MODE Then
                    ...
                    If APIDOCNUM <> "" And APICARDCODE <> "" Then
                        DocEntry = GetValue(" Select  T0.""DocEntry"" FROM ""ORPC""  T0 WHERE T0.""DocNum"" ='" + APIDOCNUM + "' And T0.""CardCode"" ='" + APICARDCODE + "' And T0.""DocDate"" ='" + APIDate + "'", "DocEntry")
                        If DocEntry <> "" Then
        ...
        Private Sub VatJounralEntry(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean, ByVal DocEntry As String)
            Try
                ...
                Dim Sql As String = ""
                Sql = "CALL SAP_GETDATA_APCREDITNOTE_VatHold_JE ('" + DocEntry + "')"
                ...
                If oRecordset.RecordCount > 0 Then
                    ...
                    oJounalEntry.Memo = "Vat Hold Based On AP Credit No  '" + oRecordset.Fields.Item("DocNum").Value.ToString & "" + "'  "
                    ...
                    oJounalEntry.Lines.BPLID = oRecordset.Fields.Item("Branch").Value
                    oJounalEntry.Lines.ShortName = oRecordset.Fields.Item("CreditAccount").Value
                    ...
                    Else
                        ...
                        SqlQuery.Append("Update ""ORPC"" Set ""U_TransId""= (Select ""TransId"" From OJDT Where ""U_ITDocE""='" + DocEntry + "' And ""U_Flag""='VH'  )")
