...
Namespace SAP_HANA
    Public Class C_Delivery : Implements ISAP_HANA
        ...
        Public Sub Form_Process_ItemEvents(FormUID As String, ByRef pVal As ItemEvent, ByRef BubbleEvent As Boolean) Implements ISAP_HANA.Form_Process_ItemEvents
            Try
                ...
                If pVal.BeforeAction = False Then
                    If pVal.FormTypeEx = "140" And pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_RESIZE Then
                    ...
                    If pVal.FormTypeEx = "140" And pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_LOAD Then
        ...
        Private Sub Chamber_OnAfterItemPressed(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
            Try
                ...
                Else
                    ...
                    Dim CardCode, TCode, TName, TruckNum, DocNum, ItemCode, ItemName, DDate As String
                    Dim Qty As Decimal
                    ...
                    TCode = oForm.Items.Item("txtTC").Specific.Value
                    TName = oForm.Items.Item("txtTN").Specific.Value
                    TruckNum = oForm.Items.Item("txtTRN").Specific.Value
                    ...
                    IsBaseForm = oForm
                    Chamber.Form_Creation(CardCode, TCode, TName, TruckNum, DDate, DocNum, ItemCode, ItemName, Qty, "Delivery")
