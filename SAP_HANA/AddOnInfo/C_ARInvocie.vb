...
Namespace SAP_HANA
    Public Class C_ARInvocie : Implements ISAP_HANA
...
#End Region
                ...
                If pVal.BeforeAction = False Then
                    ...
                    If oForm.Mode = BoFormMode.fm_ADD_MODE Or oForm.Mode = BoFormMode.fm_OK_MODE Then
                        ...
                        If APIDOCNUM <> "" And APICARDCODE <> "" Then
                            DocEntry = GetValue(" Select TOP 1  T0.""DocEntry"" FROM ""OINV""  T0 WHERE T0.""DocNum"" ='" + APIDOCNUM + "' And T0.""CardCode"" ='" + APICARDCODE + "' ORDER BY ""DocEntry"" DESC ", "DocEntry")
                            If DocEntry <> "" Then
        ...
        Private Sub VatJounralEntry(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean, ByVal DocEntry As String)
            Try
                ...
                Dim Sql As String = ""
                Sql = "CALL SAP_GETDATA_AR_PSF_JE ('" + DocEntry + "')"
                ...
                If oRecordset.RecordCount > 0 Then
                    ...
                    ' ...
                    'oJounalEntry.UserFields.Fields.Item("U_Ashok").Value = oRecordset.Fields.Item("Number").Value & ""
                    ' ...




                    oJounalEntry.Memo = "PSF  Based On AR Invoice No  '" + oRecordset.Fields.Item("DocNum").Value.ToString & "" + "'  "
                    ...
                    Else
                        ...
                        SqlQuery.Append("Update ""OINV"" Set ""U_PSFTRANSID""= (Select ""TransId"" From OJDT Where ""U_ITDocE""='" + DocEntry + "' And ""U_Flag""='PSF'  )")
        ...
        Private Sub VatJounralEntry1(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean, ByVal DocEntry As String)
            Try
                ...
                Dim oRecordset As SAPbobsCOM.Recordset = Nothing
                Dim Sql As String = ""
                Sql = "CALL SAP_GETDATA_AR_POLLUTION_JE ('" + DocEntry + "')"
                oRecordset = __bobCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                oRecordset.DoQuery(Sql)
                If oRecordset.RecordCount > 0 Then
                    ...
                    ' oJounalEntry.UserFields.Fields.Item("U_Ashok").Value = oRecordset.Fields.Item("Number").Value & ""
                    ' ...
                    oJounalEntry.Memo = "POLLUTION  Based On AR Invoice No  '" + oRecordset.Fields.Item("DocNum").Value.ToString & "" + "'  "
                    Dim amount As Double = 0.0
                    ...
                    Dim Result As Integer = oJounalEntry.Add()
                    If Result <> 0 Then
                        __oApplication.StatusBar.SetText("Error:POLLUTION JE  Not Generated - " + bobCompany.GetLastErrorDescription, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)

                    Else

                        Dim SqlQuery As New StringBuilder

                        SqlQuery.Append("Update ""OINV"" Set ""U_POLTRANSIDS""= (Select ""TransId"" From OJDT Where ""U_ITDocE""='" + DocEntry + "' And ""U_Flag""='PSF'  )")
                        SqlQuery.Append("Where ""DocEntry""='" + DocEntry + "'")
