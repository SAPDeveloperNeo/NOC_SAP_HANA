...
DROP PROCEDURE SAP_GET_AR_Invoice_Data;

Create PROCEDURE SAP_GET_AR_Invoice_Data 
(
...
SELECT  T0."DocEntry", T0."DocNum",T0."U_PDate", 
 T0."U_FW", T0."U_ITRDocE", T0."U_ITRDocN", T0."U_ITDocE", T0."U_ITDocN", 
...
CALL SAP_GET_AR_Invoice_Data (33)