DROP PROCEDURE SAP_GET_GoodIssue_TempLoss_Data;

Create PROCEDURE SAP_GET_GoodIssue_TempLoss_Data 
(
...
SELECT  T0."DocEntry", T0."DocNum",T0."U_PDate", 
 T0."U_FW", T0."U_ITRDocE", T0."U_ITRDocN", T0."U_ITDocE", T0."U_ITDocN", T0."U_TCode",T0."U_Remark" ,
T1."LineId", T1."U_ItemCode",T1."U_TemLoss",
...
WHERE T0."DocEntry" =DocEntry And  IFNULL(T1."U_TemLoss",0)>0;
 
END;


Call SAP_GET_GoodIssue_TempLoss_Data (2) ;