DROP PROCEDURE SAP_CFL_ListOfInventoryTransfer;
CREATE PROCEDURE SAP_CFL_ListOfInventoryTransfer 
(
 IN UserId INT
)
LANGUAGE SQLSCRIPT 
...
Sum(T2."U_Qty")
FROM "@SAP_OIT"  T0 
Inner Join OWHS T1 On T0."U_TW"=T1."WhsCode" And T1."U_Category"='GIT'
