DROP PROCEDURE SAP_GET_StockTransfer_GoodIssue_TempLoss_Data;

Create PROCEDURE SAP_GET_StockTransfer_GoodIssue_TempLoss_Data 
(
...
Call SAP_GET_StockTransfer_GoodIssue_TempLoss_Data (5) ;