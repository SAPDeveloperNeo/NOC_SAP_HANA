...
Case When "ChemberLoss" >0 Then "ChemberLoss" Else 0 End As "ChemberLoss",
Case When "TempLoss" >0 Then "TempLoss" Else 0 End As "TempLoss",
Case When "ClaimableLoss" >0 Then "ClaimableLoss" Else 0 End As "ClaimableLoss",
...
T0."U_Temp",T0."U_Density", T0."U_Dip", T0."U_Chamber",T3."U_CAP",T4."U_In" As "TankTemp" 
FROM "@SAP_IT1"  T0   Inner Join "@SAP_OIT" T1 On T0."DocEntry"=T1."DocEntry"
Inner Join "@SAP_OCALP" T2 On T2."U_VC"=T1."U_TRNO" and T2."U_Status"= 'Active' and T2."U_CEDate" >=Current_date
Inner Join "@SAP_CALP1" T3 On T2."DocEntry"=T3."DocEntry" And ifnull(T0."U_Chamber",'')= ifnull(cast(T3."U_CHN" as nvarchar),'')

Left Join "@SAP_TMD1" T4 On T4."U_ItemCode"=T0."U_ItemCode" And T1."U_TW"=T4."U_WhsCode" 
Inner Join "@SAP_OTMD" T5 On T5."DocEntry"=T4."DocEntry"
...
T10."U_Temp",T10."U_Density", T10."U_Dip", T10."U_CHN" As "U_Chamber",T3."U_CAP" 
...
Inner Join "@SAP_OCALP" T2 On T2."U_VC"=T0."U_TRNO" and T2."U_Status"= 'Active' and T2."U_CEDate" >=Current_date
Inner Join "@SAP_CALP1" T3 On T2."DocEntry"=T3."DocEntry" And ifnull(cast(T10."U_CHN" as nvarchar),'') = ifnull(cast(T3."U_CHN" as nvarchar),'') 
...
Call SAP_GET_Purchase_LossCalCulation (18) ;