...
DROP PROCEDURE SAP_GET_TEMP_CAL_QTY_WATER;

Create PROCEDURE SAP_GET_TEMP_CAL_QTY_WATER 
(
...
T0 Inner Join "@SAP_CALP3"  T1 On T0."DocEntry"=T1."DocEntry" Where T0."U_FAC"=:WhsCode
...
CALL SAP_GET_TEMP_CAL_QTY_WATER ('PO3MP001','110');